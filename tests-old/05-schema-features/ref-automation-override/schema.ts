...
// Source: /home/ken/hacking/projects/genlogic/tests/05-schema-features/ref-automation-override/schema.yaml
// Database: genlogic_test_cli
// Generated: 2025-11-06T18:37:43.218Z

export const schema = {
  "_metadata": {
    "generated_at": "2025-11-06T18:37:43.217Z",
    "source_schema": "/home/ken/hacking/projects/genlogic/tests/05-schema-features/ref-automation-override/schema.yaml",
    "database": "genlogic_test_cli",
    ...
    "parents": {
      ...
      "columns": {
        ...
        "total": {
          ...
          "nullable": true,
          "controlled_by": "database server",
          "formula": "COUNT(items.amount)",
          "managed_by": {
            "type": "trigger_aggregation",
            "automation_type": "COUNT",
            "source_table": "items",
            "source_column": "amount",
            "trigger_name": "items_before_insert_genlogic",
            "aggregation_path": "items.parent -> parents",
            "update_strategy": "incremental",
            "note": "Aggregates COUNT from items.amount"
          }
        }
      }
    }
