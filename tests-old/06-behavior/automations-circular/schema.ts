...
// Source: /home/ken/hacking/projects/genlogic/tests/06-behavior/automations-circular/schema.yaml
// Database: genlogic_test_cli
// Generated: 2025-11-06T18:37:49.532Z

export const schema = {
  "_metadata": {
    "generated_at": "2025-11-06T18:37:49.531Z",
    "source_schema": "/home/ken/hacking/projects/genlogic/tests/06-behavior/automations-circular/schema.yaml",
    "database": "genlogic_test_cli",
      ...
      "columns": {
        ...
        "balance": {
          ...
          "managed_by": {
            ...
            "trigger_name": "transactions_before_insert_genlogic",
            "aggregation_path": "transactions.account_fk -> accounts",
            "update_strategy": "incremental",
            "note": "Aggregates SUM from transactions.amount"
          }
        }
      }
    },
    "transactions": {
      ...
      "columns": {
        ...
        "balance_snapshot": {
          ...
          "nullable": true,
          "controlled_by": "database server",
          "formula": "SNAPSHOT(accounts.balance)",
          "managed_by": {
            "type": "trigger_aggregation",
            ...
            "trigger_name": "transactions_before_insert_genlogic",
            "cascade_path": "accounts -> transactions.account_fk",
            "update_strategy": "on_insert_only",
            "note": "Snapshot from accounts.balance (captured on INSERT only)"
          }
        }
      }
    }
