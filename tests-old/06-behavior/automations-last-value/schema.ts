...
// Source: /home/ken/hacking/projects/genlogic/tests/06-behavior/automations-last-value/schema.yaml
// Database: genlogic_test_cli
// Generated: 2025-11-06T18:37:51.568Z

export const schema = {
  "_metadata": {
    "generated_at": "2025-11-06T18:37:51.567Z",
    "source_schema": "/home/ken/hacking/projects/genlogic/tests/06-behavior/automations-last-value/schema.yaml",
    "database": "genlogic_test_cli",
    ...
    "devices": {
      ...
      "columns": {
        ...
        "last_reading": {
          ...
          "formula": "LAST_VALUE(readings.value)",
          "managed_by": {
            "type": "trigger_aggregation",
            "automation_type": "LAST_VALUE",
