...
// Source: /home/ken/hacking/projects/genlogic/tests/06-behavior/automations-max/schema.yaml
// Database: genlogic_test_cli
// Generated: 2025-11-06T18:37:51.975Z

export const schema = {
  "_metadata": {
    "generated_at": "2025-11-06T18:37:51.975Z",
    "source_schema": "/home/ken/hacking/projects/genlogic/tests/06-behavior/automations-max/schema.yaml",
    "database": "genlogic_test_cli",
    ...
    "portfolios": {
      ...
      "columns": {
        ...
        "max_investment": {
          ...
          "formula": "MAX(investments.amount)",
          "managed_by": {
            "type": "trigger_aggregation",
            "automation_type": "MAX",
            "source_table": "investments",
            "source_column": "amount",
            "trigger_name": "investments_before_insert_genlogic",
            "aggregation_path": "investments.portfolio -> portfolios",
            "update_strategy": "incremental",
            "note": "Aggregates MAX from investments.amount"
          }
        }
      }
    },
