...
// Source: /home/ken/hacking/projects/genlogic/tests/06-behavior/automations-min/schema.yaml
// Database: genlogic_test_cli
// Generated: 2025-11-06T18:37:53.204Z

export const schema = {
  "_metadata": {
    "generated_at": "2025-11-06T18:37:53.203Z",
    "source_schema": "/home/ken/hacking/projects/genlogic/tests/06-behavior/automations-min/schema.yaml",
    "database": "genlogic_test_cli",
    ...
    "products": {
      ...
      "columns": {
        ...
        "min_price": {
          ...
          "formula": "MIN(prices.amount)",
          "managed_by": {
            "type": "trigger_aggregation",
            "automation_type": "MIN",
            "source_table": "prices",
            "source_column": "amount",
            "trigger_name": "prices_before_insert_genlogic",
            "aggregation_path": "prices.product -> products",
            "update_strategy": "incremental",
            "note": "Aggregates MIN from prices.amount"
          }
        }
      }
    },
