...
// Source: /home/ken/hacking/projects/genlogic/tests/06-behavior/automations-multiple/schema.yaml
// Database: genlogic_test_cli
// Generated: 2025-11-06T18:37:54.475Z

export const schema = {
  "_metadata": {
    "generated_at": "2025-11-06T18:37:54.474Z",
    "source_schema": "/home/ken/hacking/projects/genlogic/tests/06-behavior/automations-multiple/schema.yaml",
    "database": "genlogic_test_cli",
      ...
      "columns": {
        ...
        "total_amount": {
          ...
          "managed_by": {
            ...
            "aggregation_path": "transactions.account -> accounts",
        ...
        "transaction_count": {
          ...
          "managed_by": {
            ...
            "aggregation_path": "transactions.account -> accounts",
            "update_strategy": "incremental",
            "note": "Aggregates COUNT from transactions.id"
          }
        },
        "max_transaction": {
          "type": "numeric",
          ...
          "nullable": true,
          "controlled_by": "database server",
          "formula": "MAX(transactions.amount)",
          "managed_by": {
            "type": "trigger_aggregation",
            "automation_type": "MAX",
            "source_table": "transactions",
            ...
            "aggregation_path": "transactions.account -> accounts",
            "update_strategy": "incremental",
            "note": "Aggregates MAX from transactions.amount"
          }
        }
      }
    },
