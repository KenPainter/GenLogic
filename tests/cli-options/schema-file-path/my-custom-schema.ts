...
// Source: tests/cli-options/schema-file-path/my-custom-schema.yaml
// Database: genlogic_test_cli
// Generated: 2025-10-14T20:25:23.957Z

export const schema = {
  "_metadata": {
    "generated_at": "2025-10-14T20:25:23.956Z",
    "source_schema": "tests/cli-options/schema-file-path/my-custom-schema.yaml",
    "database": "genlogic_test_cli",
